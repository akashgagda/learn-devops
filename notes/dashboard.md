---
tags: [devops, roadmap, go]
---

# Dashboard — learn-devops
...
1. Git → 2. Go (in progress) → 3. Linux & Bash → 4. Networking & Security →
5. Server Management → 6. Docker → 7. Kubernetes → 8. IaC →
9. CI/CD → 10. Monitoring → 11. Cloud → 12. Practices → DevSecOps
